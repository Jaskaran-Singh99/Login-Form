...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $unique = "SELECT * FROM `login` WHERE name= '$username'"  ;
    $uniqueResult = mysqli_query($connection, $unique);

    $row = mysqli_num_rows($uniqueResult);
    ...
    if($row > 0){
      ...
      if($password == $cpassword){
        $sql = "INSERT INTO `login` (`name`, `password`, `date`) VALUES ( '$username', '$password', current_timestamp());";
